package com.bcbs239.regtech.reportgeneration.presentation.web;
 ...
 * Provides consistent response formatting for report generation endpoints.
 */
@Component
public class ReportResponseHandler {
