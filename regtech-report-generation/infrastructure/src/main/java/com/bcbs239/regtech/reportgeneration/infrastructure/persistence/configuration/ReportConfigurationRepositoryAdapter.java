...
public class ReportConfigurationRepositoryAdapter implements ReportConfigurationRepository {
    ...
    private ReportConfiguration toDomain(ReportConfigurationJpaEntity entity) {
        return ReportConfiguration.builder()
                ...
                .template(ReportTemplate.of(entity.getTemplate()).getValueOrThrow())
                .language(ReportLanguage.of(entity.getLanguage()).getValueOrThrow())
                .outputFormat(OutputFormat.of(entity.getOutputFormat()).getValueOrThrow())
                .frequency(ReportFrequency.of(entity.getFrequency()).getValueOrThrow())
                ...
                .scheduleDay(ScheduleDay.of(entity.getScheduleDay()).getValueOrThrow())
