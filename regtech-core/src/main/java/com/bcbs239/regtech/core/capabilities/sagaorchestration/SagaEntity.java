...
import com.bcbs239.regtech.core.capabilities.sharedinfrastructure.SystemTimeProvider;
...
public class SagaEntity {
    ...
    public SagaEntity(String sagaId, String sagaType, SagaStatus status, Instant startedAt, 
                     String sagaData, String processedEvents, String pendingCommands, Instant completedAt, Instant completedAt) {
        this.sagaId = sagaId;
