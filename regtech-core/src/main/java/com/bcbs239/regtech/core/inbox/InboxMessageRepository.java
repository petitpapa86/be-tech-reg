...
public interface InboxMessageRepository {
     ...
     */
    Function<Integer, List<InboxMessageDto>> messageLoader();
     ...
     */
    default Function<Integer, List<InboxMessageDto>> failedMessageLoader() { return batch -> List.of(); }
     ...
     */
    default Function<Integer, List<InboxMessageDto>> claimBatch() { return messageLoader(); }
