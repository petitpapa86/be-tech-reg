...
@Service
@Transactional
public class BillingEventPublisher implements OutboxEventPublisher {
    ...
    public OutboxEventStats getStats() {
        EventPublishingStats stats = getStatsWithClosures(eventCountByStatus());
        return new OutboxEventStats(
            stats.pending(),
            stats.processing(),
            stats.processed(),
            stats.failed(),
