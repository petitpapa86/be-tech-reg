...
public class InvoiceLineItemEntity {
     ...
     * Note: invoiceId will be set automatically by JPA via @JoinColumn relationship
     */
    public static InvoiceLineItemEntity fromDomain(InvoiceLineItem lineItem) {
        InvoiceLineItemEntity entity = new InvoiceLineItemEntity();
        
        // Don't set ID or invoiceId - both are managed by JPA
        // entity.id will be auto-generated by @GeneratedValue
        // entity.invoiceId will be set by JPA via @JoinColumn relationship
