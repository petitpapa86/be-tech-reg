package com.bcbs239.regtech.billing.domain.services;
...
public interface PaymentService {
     ...
     */
    Result<com.bcbs239.regtech.billing.domain.events.WebhookEvent> verifyAndParseWebhook(String payload, String signatureHeader);
