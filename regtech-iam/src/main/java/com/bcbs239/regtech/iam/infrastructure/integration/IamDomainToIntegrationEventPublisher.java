...
@Component
public class IamDomainToIntegrationEventPublisher {

    private static final Logger logger = LoggerFactory.getLogger(IamDomainToIntegrationEventPublisher.class);
