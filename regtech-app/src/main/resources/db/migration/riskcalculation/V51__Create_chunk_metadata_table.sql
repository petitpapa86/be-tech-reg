...
CREATE TABLE riskcalculation.chunk_metadata (
    ...
    CONSTRAINT fk_chunk_metadata_portfolio_analysis 
        ...
        REFERENCES riskcalculation.portfolio_analysis(id) 
        ON DELETE CASCADE,
...
CREATE INDEX idx_chunk_metadata_portfolio_analysis ON riskcalculation.chunk_metadata(portfolio_analysis_id);
