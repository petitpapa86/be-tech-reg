...
public class IngestionSecurityService {
    ...
    public Result<BankId> validateTokenAndExtractBankId(String authToken) {
        ...
        try {
            ...
            if (!permissionService.isValidToken(authToken)) {
                ...
                return Result.failure(ErrorDetail.authenticationError("Invalid or expired JWT token"));
            }
            ...
            if (bankIdValue == null || bankIdValue.trim().isEmpty()) {
                ...
                return Result.failure(ErrorDetail.authenticationError("Bank ID not found in JWT token"));
            }
            ...
            return Result.failure(ErrorDetail.systemError("Token validation failed: " + e.getMessage()));
        }
    }
    ...
    public Result<Void> verifyBankPermissions(BankId requestedBankId) {
        ...
        try {
            ...
            if (!SecurityUtils.canAccessBank(requestedBankId.value())) {
                ...
                return Result.failure(ErrorDetail.authorizationError(
            ...
            return Result.failure(ErrorDetail.systemError("Permission check failed: " + e.getMessage()));
        }
    }
    ...
    public Result<Void> verifyBatchAccess(BatchId batchId, BankId batchBankId) {
        ...
        try {
            ...
            return Result.failure(ErrorDetail.systemError("Batch access check failed: " + e.getMessage()));
        }
    }
