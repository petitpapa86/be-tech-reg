...
class BatchSpecificationsTest {
    ...
    void mustNotBeTerminal_should_fail_for_completed() {
        IngestionBatch batch = new IngestionBatch(BatchId.generate(), BankId.of("B1").getValueOrThrow(), BatchStatus.COMPLETED,
    ...
    void mustHaveS3Reference_should_fail_when_missing_and_succeed_when_present() {
        ...
        IngestionBatch batchWithS3 = new IngestionBatch(BatchId.generate(), BankId.of("B1").getValueOrThrow(), BatchStatus.UPLOADED,
    ...
    void mustHaveExposureCount_should_fail_for_invalid_and_succeed_for_valid() {
        IngestionBatch batch = new IngestionBatch(BatchId.generate(), BankId.of("B1").getValueOrThrow(), BatchStatus.UPLOADED,
        ...
        IngestionBatch batch2 = new IngestionBatch(BatchId.generate(), BankId.of("B1").getValueOrThrow(), BatchStatus.UPLOADED,
    ...
    void mustBeUploaded_should_enforce_uploaded_state() {
        ...
        IngestionBatch b2 = new IngestionBatch(BatchId.generate(), BankId.of("B1").getValueOrThrow(), BatchStatus.VALIDATED,
