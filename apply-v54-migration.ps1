# PowerShell script to apply V54 migration
# Adds version column for optimistic locking to batches table

Write-Host "========================================" -ForegroundColor Cyan
Write-Host "Batch Entity Versioning" -ForegroundColor Cyan
Write-Host "Migration V54: Add version to batches" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

Write-Host "This migration will:" -ForegroundColor Yellow
Write-Host "  1. Add version BIGINT column to riskcalculation.batches table" -ForegroundColor White
...
try {
    ...
    if ($LASTEXITCODE -eq 0) {
        Write-Host ""
        Write-Host "Migration V54 applied successfully!" -ForegroundColor Green
        Write-Host "The version column has been added to the batches table." -ForegroundColor White
        Write-Host ""
    } else {
        Write-Host ""
