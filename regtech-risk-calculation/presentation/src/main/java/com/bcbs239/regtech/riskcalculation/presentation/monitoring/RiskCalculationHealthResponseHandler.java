 ...
 */
@Component
public class RiskCalculationHealthResponseHandler {
    
    private static final Logger logger = LoggerFactory.getLogger(RiskCalculationHealthResponseHandler.class);
     ...
     */
    public ServerResponse handleMetricsResponse(RiskCalculationMetrics metrics) {
        try {
