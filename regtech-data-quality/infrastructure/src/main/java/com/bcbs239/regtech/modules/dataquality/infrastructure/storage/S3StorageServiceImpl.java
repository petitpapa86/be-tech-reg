package com.bcbs239.regtech.modules.dataquality.infrastructure.storage;
...
public class S3StorageServiceImpl implements S3StorageService {
    ...
    private String serializeValidationResult(ValidationResult validationResult) throws IOException {
        ...
        int count = 0;
        for (Map.Entry<String, com.bcbs239.regtech.modules.dataquality.domain.validation.ExposureValidationResult> entry : 
            ...
            if (!entry.getValue().isValid()) {
                ...
                for (com.bcbs239.regtech.modules.dataquality.domain.validation.ValidationError error : entry.getValue().getErrors()) {
        ...
        for (com.bcbs239.regtech.modules.dataquality.domain.validation.ValidationError error : validationResult.getBatchErrors()) {
            Map<String, Object> errorMap = new HashMap<>();
            errorMap.put("dimension", error.dimension().toString());
            errorMap.put("ruleCode", error.ruleCode());
            errorMap.put("message", error.message());
