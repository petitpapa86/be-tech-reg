...
public class SectorValidator {
    ...
    /**
     * Check if a sector is compatible with a counterparty type.
     *
     ...
     */
    public static boolean isCompatibleWithCounterpartyType(String sector, String counterpartyType) {
        ...
        if (FINANCIAL_SECTORS.contains(normalizedSector)) {
            return Set.of("BANK", "INSURANCE_COMPANY", "INVESTMENT_FUND", "PENSION_FUND",
                         "CENTRAL_BANK", "OTHER_FINANCIAL").contains(normalizedType);
        }

        // Corporate sectors should match corporate counterparty types
        if (CORPORATE_SECTORS.contains(normalizedSector)) {
            return Set.of("CORPORATE", "SME", "NON_FINANCIAL_CORPORATE").contains(normalizedType);
        }
    ...
    /**
     * Check if a sector is classified as financial.
     *
    ...
    /**
     * Check if a sector is classified as corporate.
     *
     * @param sector the sector code to check
    ...
    /**
     * Check if a sector is classified as government.
     *
     * @param sector the sector code to check
    ...
    /**
     * Check if a sector is classified as retail.
     *
     * @param sector the sector code to check
